package net.davidnorton.repository;

import net.davidnorton.JHipsterTasksApp;
import net.davidnorton.config.Constants;
import net.davidnorton.config.audit.AuditEventConverter;
import net.davidnorton.domain.PersistentAuditEvent;
...
import static net.davidnorton.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
