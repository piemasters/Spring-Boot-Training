...
import net.davidnorton.JHipsterTasksApp;
import net.davidnorton.domain.Authority;
import net.davidnorton.domain.User;
import net.davidnorton.repository.AuthorityRepository;
...
import net.davidnorton.web.rest.errors.ExceptionTranslator;
import net.davidnorton.web.rest.vm.KeyAndPasswordVM;
import net.davidnorton.web.rest.vm.ManagedUserVM;
