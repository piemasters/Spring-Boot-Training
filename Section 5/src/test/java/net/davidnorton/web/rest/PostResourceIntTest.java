...
import net.davidnorton.domain.Post;
import net.davidnorton.repository.PostRepository;
import net.davidnorton.service.PostService;
...
import static net.davidnorton.web.rest.TestUtil.createFormattingConversionService;
